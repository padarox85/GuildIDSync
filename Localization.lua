local L = {
    ...
    ["UI_LAYER_UNKNOWN"] = "unknown - NovaWorldBuffs required",
    ["UI_LAYER_UNKNOWN_PROMPT"] = "Unknown Layer - NovaWorldBuffs required for detection!",
    ["UI_LAYER_REQUIRES_NWB"] = "NovaWorldBuffs is required for layer detection. Please install and activate it.",
    ["UI_LAYER_NWB_LINK_LABEL"] = "Download here (Ctrl+C to copy):",
    ["UI_LAYER_INVITE_IN_GROUP_ERROR"] = "You cannot request a layer switch while in a group or raid.",
...
if GetLocale() == "deDE" then
    ...
    GS_L["UI_LAYER_UNKNOWN"] = "unbekannt - NovaWorldBuffs wird benötigt"
    GS_L["UI_LAYER_UNKNOWN_PROMPT"] = "Unbekannter Layer - NovaWorldBuffs zur Erkennung benötigt!"
    GS_L["UI_LAYER_REQUIRES_NWB"] = "NovaWorldBuffs wird für die Layer-Erkennung benötigt. Bitte installiere und aktiviere es."
    GS_L["UI_LAYER_NWB_LINK_LABEL"] = "Hier herunterladen (Strg+C zum Kopieren):"
    GS_L["UI_LAYER_INVITE_IN_GROUP_ERROR"] = "Du kannst keinen Layer-Wechsel anfragen, während du in einer Gruppe oder einem Raid bist."
